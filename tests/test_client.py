...
class TestClient(unittest.TestCase):
    ...
    def test_add_camera_kwrgs_ip(self, mock_post):
        ...
        kwargs = {'reference_url': 'url.com/ref', 'reference_logo': 'Logo', 'timezone_name': 'Test',
    ...
    def test_add_camera_kwrgs_no_ip(self, mock_post):
        ...
        data = {'reference_url': 'url.com/ref', 'reference_logo': 'Logo', 'timezone_name': 'Test', 'timezone_id': 'GMT',
                ...
                'country': 'USA', 'longitude': '100.21323', 'latitude': '-44.9281', 'source': 'source',
                'legacy_cameraID': None, 'm3u8_url': 'sample.com/m3u8_url', 'snapshot_url': 'sample.com/snapshot_url',
                'is_active_video': False, 'is_active_image': True, 'type': 'ip', 'ip': None, 'port': '8080',
                'brand': 'Some Brand', 'model': 'Some model', 'image_path': 'path/image', 'video_path': 'path/video'}
        ...
        kwargs = {'reference_url': 'url.com/ref', 'reference_logo': 'Logo', 'timezone_name': 'Test',
                  ...
                  'snapshot_url': 'sample.com/snapshot_url',
                  'is_active_video': False, 'is_active_image': True, 'type': 'ip',
                  'ip': None, 'port': '8080', 'brand': 'Some Brand',
                  'model': 'Some model', 'image_path': 'path/image', 'video_path': 'path/video'}
        resultID = client.add_camera(**kwargs)
        mock_post.assert_called_once_with(url, headers=header, data=data)
        self.assertEqual(resultID, expected_camID)
    ...
    def test_add_camera_kwrgs_non_ip(self, mock_post):
        ...
        kwargs = {'video_path': None, 'image_path': None, 'model': None, 'brand': None, 'port': None,
    ...
    def test_add_camera_kwrgs_no_snapshot_url(self, mock_post):
        ...
        data = {'video_path': None, 'image_path': None, 'model': None, 'brand': None, 'port': None,
                ...
                'city': 'West Lafayette', 'state': 'Indiana', 'country': 'USA', 'longitude': 'test_long',
                'latitude': 'test_lad', 'source': 'test_source', 'legacy_cameraID': 0, 'ip': None, 'm3u8_url': None,
                'is_active_video': True, 'is_active_image': False, 'type': 'non-ip', 'snapshot_url': None}
    ...
    def test_add_camera_kwrgs_stream(self, mock_post):
        ...
        kwargs = {'video_path': None, 'image_path': None, 'model': None, 'brand': None, 'port': None,
                  ...
                  'type': 'stream', 'm3u8_url': 'test_m3u8'}
        resultID = client.add_camera(**kwargs)
        mock_post.assert_called_once_with(url, headers=header, data=data)
        self.assertEqual(resultID, expected_camID)
        self.assertEqual(1, mock_response.json.call_count)
    ...
    def test_add_camera_kwrgs_no_m3u8_url(self, mock_post):
        ...
        data = {'video_path': None, 'image_path': None, 'model': None, 'brand': None, 'port': None,
                ...
                'city': 'West Lafayette', 'state': 'Indiana', 'country': 'USA', 'longitude': 'test_long',
                'latitude': 'test_lad', 'source': 'test_source', 'legacy_cameraID': 0, 'ip': None, 'snapshot_url': None,
                'is_active_video': True, 'is_active_image': False, 'type': 'stream', 'm3u8_url': None}
    ...
    def test_add_camera_expired_token_success(self, mock_get, mock_post):
        ...
        kwargs = {'reference_url': 'test_ref_url', 'reference_logo': 'test_ref_logo', 'timezone_name': 'test_t_name',
                  'timezone_id': 'test_t_id', 'utc_offset': 3, 'resolution_height': 480,
                  ...
                  'legacy_cameraID': 0, 'm3u8_url': None,
                  'snapshot_url': None,
    ...
    @mock.patch('pythonAPIClient.client.requests.post')
    def test_add_camera_missing_required_args(self, mock_post):
        clientId = '0' * 96
        clientSecret = '0' * 71
        client = Client(clientId, clientSecret)
        client.token = 'CorrectToken'
