...
class TestClient(unittest.TestCase):
    ...
    def test_update_camera_ip(self, mock_put):
        ...
        header = {'Authorization': 'Bearer correctToken'}
        data = {'url': 'https://cam2-api.herokuapp.com/cameras/5ae0ecbd336359291be74c12',
                'testCamID': '5ae0ecbd336359291be74c12', 'video_path': 'test_vid_path', 'image_path': 'test_image_path',
                'model': 'test_model', 'brand': 'test_brand', 'port': '8080', 'reference_url': 'test_ref_url',
                ...
                'source': 'test_source', 'legacy_cameraID': 0, 'm3u8_url': None, 'snapshot_url': None,
                'ip': '127.0.0.2', 'is_active_video': True, 'is_active_image': False, 'type': 'ip',
                'retrieval': '{\n    "brand":"test_brand",\n    "image_path":"test_image_path",\n    '
                             '"ip":"127.0.0.2",\n    "model":"test_model",\n    "port":"8080",\n    '
                             '"video_path":"test_vid_path"\n}'}

        resultID = client.update_camera(camera_type='ip', is_active_image=False, is_active_video=True, ip='127.0.0.2',
    ...
    def test_update_camera_non_ip(self, mock_put):
        ...
        header = {'Authorization': 'Bearer correctToken'}
        data = {'url': 'https://cam2-api.herokuapp.com/cameras/5ae0ecbd336359291be74c12',
                'testCamID': '5ae0ecbd336359291be74c12', 'video_path': None, 'image_path': None, 'model': None,
        ...
        resultID = client.update_camera(camera_type='non-ip', is_active_image=False, is_active_video=True,
    ...
    def test_update_camera_stream(self, mock_put):
        ...
        resultID = client.update_camera(camera_type='stream', is_active_image=False, is_active_video=True,
    ...
    def test_update_camera_internal_error(self, mock_put):
        ...
        with self.assertRaises(InternalError):
            client.update_camera(camera_type='ip', is_active_image=False, is_active_video=True, ip='127.0.0.2',
                                 snapshot_url=None, m3u8_url=None, legacy_cameraID=000000000,
                                 source='test_source', latitude='test_lad', longitude='test_long', country='USA',
                                 state='Indiana', city='West Lafayette', resolution_width=720,
                                 resolution_height=480, utc_offset=3, timezone_id='test_t_id',
