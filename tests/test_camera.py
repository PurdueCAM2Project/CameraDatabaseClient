...
class TestCamera(unittest.TestCase):
    ...
    def test_cam_init(self):
        ...
        self.assertTrue(isinstance(non_ip_cam_test2, NonIPCamera) and issubclass(non_ip_cam_test2.__class__, cam.__class__))


        self.assertTrue(isinstance(stream_cam_test1, StreamCamera) and issubclass(stream_cam_test1.__class__, cam.__class__))
        self.assertTrue(isinstance(stream_cam_test2, StreamCamera) and issubclass(stream_cam_test2.__class__, cam.__class__))
